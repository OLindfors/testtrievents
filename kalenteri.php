...
<li class="active"><a href="bike.php"><b>Kisakalenteri ja ilmoittautuminen</b></a></li>
...
<br>
<a href = "Ilmoittautuminen.php"><button class="btn btn-md" disabled>Ilmoittaudu Helsinkiin!</button></a>
...
<br>
<a href = "Ilmoittautuminen.php"><button class="btn btn-md" disabled>Ilmoittaudu Turkuun!</button></a>
<br>
<br>
</div>
<div class="col-sm-4" style="text-align:center">
...
<br>
<a href = "Ilmoittautuminen.php"><button class="btn btn-md" onclick="oletus3()">Ilmoittaudu Lahteen!</button></a>
<br>
<br>
</div>
</div>
...
<br>
<a href = "Ilmoittautuminen.php"><button class="btn btn-md">Ilmoittaudu Kuopioon!</button></a>
...
<br>
<a href = "Ilmoittautuminen.php"><button class="btn btn-md">Ilmoittaudu Jyväskylään!</button></a>
<br>
<br>
</div>
...
<br>
<a href = "Ilmoittautuminen.php"><button class="btn btn-md">Ilmoittaudu Ouluun!</button></a>
<br>
<br>
</div>
</div>
